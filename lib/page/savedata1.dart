...
class Savedata1 extends StatefulWidget {
  const Savedata1({Key? key}) : super(key: key);

  @override
  State<Savedata1> createState() => _Savedata1State();
}

class _Savedata1State extends State<Savedata1> {
  final formKey = GlobalKey<FormState>();
  String? dropValue2, species;
  final TextEditingController _areaController = TextEditingController();

  String disease = 'โรคใบไหม้แผลใหญ่';
  late String date;
