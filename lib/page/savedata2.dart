...
class Savedata2 extends StatefulWidget {
  const Savedata2({Key? key}) : super(key: key);

  @override
  State<Savedata2> createState() => _Savedata2State();
}

class _Savedata2State extends State<Savedata2> {
  final formKey = GlobalKey<FormState>();
  String? dropValue2, species;
  final TextEditingController _areaController = TextEditingController();

  String disease = 'โรคราสนิม';
  late String date;
